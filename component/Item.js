/**
 * @author Bird
 * @repo @repo https://gitlab.com/flyingbird/flyingbird.1.0
 */
'use strict';
...
export default class Item extends Component {
  ...
  _render() {
    ...
    return (
      <View style={[styles.listItem, { marginLeft: 16, borderTopWidth: !first ? 1 : 0, borderColor: "#BDBEC0" }]}>
        {icon ? (<Icon name={icon} size={px2dp(iconSize || 20)} style={{ width: 22, marginRight: 15, textAlign: "center" }} color={color || "#4da6f0"} />) : null}
  ...
  render() {
    ...
    return disable ?
      ...
      <Button style={{ marginTop: 0 }} onPress={onPress}>{this._render()}</Button>
  }
}
